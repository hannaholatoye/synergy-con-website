...
const config: Config = {
  ...
  secondary: "#111111",    // deep section bg
  accent: "#EAEAEA",       // soft highlight

  // TEXT
  MidnightNavyText: "#111111",
  SlateBlueText: "#666666",
  darktext: "#9CA3AF",
  ...
  // BORDERS
  dark_border: "#222222",
  PeriwinkleBorder: "#E5E5E5",

  // OPTIONAL subtle brand accents (use VERY sparingly)
  highlightGold: "#C7A86D",
